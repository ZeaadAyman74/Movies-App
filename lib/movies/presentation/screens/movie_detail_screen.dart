  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsBloc>()
        ..add(GetMovieDetailsEvent(movieId: id, name: ''))
...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      ...
      builder: (context, state) {
        print("movieDetails ${state.movieDetailsState}");
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      ...
      builder: (context, state) {
        print("Recommendations ${state.recommendationState}");
        switch (state.recommendationState) {
          ...
          case RequestState.error:
            return Text(state.recommendationMessage);
        }
      },
    );
  }
