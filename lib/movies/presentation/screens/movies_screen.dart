...
import 'package:movies_app/movies/presentation/components/now_playing_componet.dart';
...
class MainMoviesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        return sl<MoviesBloc>()..add(GetNowPlayingEvent())..add(GetPopularMoviesEvent())..add(GetTopRatedMoviesEvent());
      },
      child: Scaffold(
